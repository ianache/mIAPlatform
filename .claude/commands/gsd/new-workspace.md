...
<execution_context>
@D:/02-PERSONAL/01-PROJECTS/22-mIAPlatform/.claude/get-shit-done/workflows/new-workspace.md
@D:/02-PERSONAL/01-PROJECTS/22-mIAPlatform/.claude/get-shit-done/references/ui-brand.md
</execution_context>

<process>
Execute the new-workspace workflow from @D:/02-PERSONAL/01-PROJECTS/22-mIAPlatform/.claude/get-shit-done/workflows/new-workspace.md end-to-end.
