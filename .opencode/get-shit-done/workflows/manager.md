...
```bash
INIT=$(node "D:/02-PERSONAL/01-PROJECTS/22-mIAPlatform/.opencode/get-shit-done/bin/gsd-tools.cjs" init manager)
...
Steps:
1. Read the plan-phase workflow: cat D:/02-PERSONAL/01-PROJECTS/22-mIAPlatform/.opencode/get-shit-done/workflows/plan-phase.md
2. Run: node \"D:/02-PERSONAL/01-PROJECTS/22-mIAPlatform/.opencode/get-shit-done/bin/gsd-tools.cjs\" init plan-phase {N}
...
Steps:
1. Read the execute-phase workflow: cat D:/02-PERSONAL/01-PROJECTS/22-mIAPlatform/.opencode/get-shit-done/workflows/execute-phase.md
2. Run: node \"D:/02-PERSONAL/01-PROJECTS/22-mIAPlatform/.opencode/get-shit-done/bin/gsd-tools.cjs\" init execute-phase {N}
