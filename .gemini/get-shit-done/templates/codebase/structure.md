...
- Usage: Reference from command with `@D:/02-PERSONAL/01-PROJECTS/22-mIAPlatform/.gemini/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to D:/02-PERSONAL/01-PROJECTS/22-mIAPlatform/.gemini/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/02-PERSONAL/01-PROJECTS/22-mIAPlatform/.gemini/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
