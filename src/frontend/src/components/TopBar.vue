<template>
  <header class="sticky top-0 z-50 flex items-center justify-between px-4 py-3 glass">
    ...
    <!-- Right: Theme Toggle + User Avatar with Dropdown -->
    <div class="flex items-center gap-3 flex-shrink-0">
      ...
      >
        ...
        <svg v-if="themeStore.theme === 'dark'" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
