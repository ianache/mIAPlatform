...
onMounted(async () => {
    try {
        ...
        form.registry_model_id = agent.registry_model_id ?? '';
...
if (__VLS_ctx.loadingAgent) {
    ...
    // @ts-ignore
    [agentLoaded, successMessage, successMessage,];
    var __VLS_3;
    ...
    const __VLS_26 = __VLS_asFunctionalComponent1(__VLS_25, new __VLS_25({
        ...{ 'onUpdate:provider': {} },
        ...{ 'onUpdate:registryModelId': {} },
        ...{ 'onUpdate:temperature': {} },
        provider: (__VLS_ctx.form.provider),
        registryModelId: (__VLS_ctx.form.registry_model_id),
    ...
    const __VLS_32 = ({ 'update:registryModelId': {} },
        { 'onUpdate:registryModelId': (...[$event]) => {
                if (!!(__VLS_ctx.loadingAgent))
                    return;
                if (!!(__VLS_ctx.notFound))
                    return;
                if (!(__VLS_ctx.agentLoaded))
                    return;
                __VLS_ctx.form.registry_model_id = $event;
                // @ts-ignore
                [form,];
            } });
    ...
    (__VLS_ctx.agentStore.loading ? 'Saving...' : 'Save Changes');
}
// @ts-ignore
