...
export const useAuthStore = defineStore('auth', {
    state: () => ({
        accessToken: localStorage.getItem('mia_access_token'),
        refreshToken: localStorage.getItem('mia_refresh_token'),
        idToken: localStorage.getItem('mia_id_token'),
        user: null,
        avatarUrl: localStorage.getItem('mia_user_avatar_url'),
    }),
    getters: {
    ...
    actions: {
        ...
        setTokens(access, refresh, id) {
            ...
            if (id)
                localStorage.setItem('mia_id_token', id);
        },
        setAvatarUrl(url) {
            this.avatarUrl = url;
